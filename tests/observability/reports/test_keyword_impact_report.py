...
def _flag(term: str, *, at_minutes: float = 0.0, article: str = 'a1',
          title: str = 'Federal Reserve issues FOMC statement') -> _Flag:
    return _Flag(article_id=article, title=title, at=_NOW + timedelta(minutes=at_minutes),
...
def test_one_article_matching_two_terms_counts_for_both_and_the_header_says_so():
    ...
    both = _Flag(article_id='a1', title='Fed statement amid intervention talk', at=_NOW,
                 terms=('fomc statement', 'intervention'))
